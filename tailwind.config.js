  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        ...
        circularLightLg: 'repeating-radial-gradient(rgb(0,0,0,0.4) 2px, #f5f5f5 5px, #f5f5f5 80px);',
        circularDarkLg: 'repeating-radial-gradient(rgb(255,255,255,0.5) 2px, #1b1b1b 8px, #1b1b1b 80px);',
    ...
    screens: {
      ...
      xs: { max: '479px' },
      // => @media (max-width: 479px) { ... } => @media(max-width: 1535px)
    },
  },
  plugins: [],
}
